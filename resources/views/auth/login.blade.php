          ...
          <section class="login_content">
            <form method="POST" action="{{ route('login') }}">
              ...
              <div>
                ...
                {{ $errors->first('password'), '<span class="help-block">Contraseña Invalida</span>' }}  
              </div>
              @if ($errors->has('password'))
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $errors->first('password') }}</strong>
              ...
              <div>
                <button class="btn btn-default submit btn-block btn-primary" type="submit">Ingresar</button><br>
